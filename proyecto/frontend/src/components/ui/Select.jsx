...
function Trigger({ children, placeholder, className = "", ...props }) {
  return (
    <SelectPrimitive.Trigger
      {...props}
      className={`flex items-center justify-between gap-2 w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 text-sm focus:ring-2 focus:ring-brand-500/30 focus:border-brand-400 outline-none transition-all data-[placeholder]:text-gray-400 ${className}`}
    >
